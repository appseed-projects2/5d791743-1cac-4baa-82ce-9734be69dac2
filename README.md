...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-28 14:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5d791743-1cac-4baa-82ce-9734be69dac2.git
$ cd 5d791743-1cac-4baa-82ce-9734be69dac2
```
